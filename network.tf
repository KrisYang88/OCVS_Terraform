...
# --------- Create Internet, NAT, Service Gateways
...
# --------- Create Public and Private Subnets for Bastion / Jumphost
...
resource "oci_core_subnet" "private-subnet" {
  ...
  security_list_ids          = [oci_core_security_list.private-security-list[0].id]
  dns_label                  = "private"
